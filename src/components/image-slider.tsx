...
export default function ImageSlider() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-50">
     <br></br> <div className="w-full max-w-2xl mx-auto">
      <h1 className="text-5xl font-bold text-center mb-4 underline decoration-blue-800 decoration-4 text-blue-800">Image Slider</h1>

        <b><p className="text-center text-gray-600 mb-8">
        ...
        >
            ...
            {images.map((image, index) => (
              ...
              >
                ...
                <div className="p-2 bg-white/75 text-center">
                  <h2 className="text-lg font-bold  text-blue-800">{image.user.name}</h2>
                  <p className="text-sm">
         ...
         <br></br><br></br><br></br> <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2">
            <Button
              variant="ghost"
              size="icon"
            ...
            >
              {isPlaying ? (
                <PauseIcon className="w-6 h-6 text-blue-800" />
              ) : (
                <PlayIcon className="w-6 h-6 text-blue-800" />
              )}
